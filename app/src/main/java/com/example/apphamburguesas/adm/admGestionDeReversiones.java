...
import com.example.apphamburguesas.adm.gestionDeReversiones.admReversos;

import java.util.HashMap;
import java.util.Map;

public class admGestionDeReversiones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adm_gestion_de_reversiones);
